...
function checkAndCreateDatabase() {
    ...
    try {
        // =====================================================
        // STAP 1: VERBINDEN MET MYSQL SERVER (ZONDER DATABASE)
        // =====================================================
        $pdo = new PDO("mysql:host=$host;charset=$chrs", $dbuser, $pass, $opts);
        
        // =====================================================
        // STAP 2: CONTROLEREN OF DATABASE BESTAAT
        // =====================================================
        ...
        // =====================================================
        // STAP 3: VERBINDEN MET DE SPECIFIEKE DATABASE
        // =====================================================
        $pdo = new PDO($attr, $dbuser, $pass, $opts);
        
        // =====================================================
        // STAP 4: CONTROLEREN OF USERS TABEL BESTAAT
        // =====================================================
        ...
        if ($stmt->rowCount() == 0) {
            ...
            // =====================================================
            // STAP 5: STANDAARD ADMIN GEBRUIKER AANMAKEN
            // =====================================================
            // Maak een standaard admin gebruiker aan voor eerste toegang
            $admin_username = 'admin';
            $admin_password = 'password123';
            $hashed_admin_password = password_hash($admin_password, PASSWORD_DEFAULT);
            
            // Voeg admin gebruiker toe aan database
            $stmt = $pdo->prepare("INSERT INTO users (username, password, role) VALUES (?, ?, 'admin')");
            $stmt->execute([$admin_username, $hashed_admin_password]);
            
            logMessage("Tabel 'users' is aangemaakt.");
            logMessage("Standaard admin gebruiker 'admin' aangemaakt met wachtwoord 'password123'.");
        } else {
        ...
        // Foutafhandeling voor database problemen
